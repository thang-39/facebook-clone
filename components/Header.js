  ...
  <div className='bg-white flex items-center p-2 shadow-md top-0 sticky z-50 h-16'>
    ...
    <div className='flex min-w-fit'>
      <Image 
        ...
        width={40}
      />
      <div className='flex items-center space-x-2 px-2 ml-2 rounded-full bg-gray-100 text-gray500'>
        <HiOutlineSearch size={20} />
        <input 
          className='hidden lg:inline-flex bg-transparent focus:outline-none' type="text"
